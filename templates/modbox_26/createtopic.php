...
$query1->close();
?>
<div class="forumcontainer"><div class="forumheader"><a href="<?php echo $setting['siteurl'].'index.php?act=forum';?>">Forum</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="<?php echo $setting['siteurl'].'index.php?act=forumcats&id='.intval($_GET['cat']);?>"><?php echo $cat_data ['name'];?></a>&nbsp;&nbsp;>&nbsp;&nbsp;New Topic</div>
<?php
...
?>
    <div id="commentBox">
        ...
        Details:<br /><textarea name="text" rows="6" cols="88" id="text"></textarea><br /><br />
