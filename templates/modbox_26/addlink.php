...
<div class="container_box5"><font color="blue">Please add our link to your site with the following information:</font></div>
<div class="container_box5"><b>Text:</b> <?php echo $setting['sitename'];?> <br>
...
<div class="linkbox1">Text:</div><div class="linkbox2"><input type="text" name="text" value="<?php echo $post_text;?>"></div><div style="clear:both"></div>
<div class="linkbox1">Description:</div><div class="linkbox2"><input type="text" name="description" value="<?php echo $post_desc;?>"></div><div style="clear:both"></div>
<div class="linkbox1">Url:</div><div class="linkbox2"><input type="text" name="url" value="<?php echo $post_url;?>"></div><div style="clear:both"></div>
<div class="linkbox1">Email:</div><div class="linkbox2"><input type="text" name="linkemail" value="<?php echo $post_linkemail;?>"></div><div style="clear:both"></div>
<div class="linkbox1">Reciprocal link:</div><div class="linkbox2"><input type="text" name="reciprocal" value="<?php echo $post_reciprocal;?>"></div><div style="clear:both"></div>
<div class="container_box5"><center><?php
...
?></div>
<div class="container_box5"><input type='hidden' name='act' value='addlink'>
