         <div id="center">
<div class="terms_main_header">Terms/F.A.Q./Legal Notice</div>   
<div class="terms_main_box">          
<?php
echo '<div id="terms">
...
are not in any way for sale, resale, or distribution through '.$setting['sitename'].'. If you feel that 
...
We attempt to moderate it to some degree, but we can not watch everything all the time. 
If you have a problem with somebody, or something they do or 
...
Please bear in mind though that we do try to give people some leeway in here.</li>
