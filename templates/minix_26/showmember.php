...
<div class="clear"></div>
<div class="container_box1">
<div id="headergames2">Member<?php echo"'";?>s Comments:</div>
...
<textarea name="comment" rows="4" cols="40" id="comment_message" style="color:#999;" onkeyup="noBad(this);" onblur="this.value = this.value || this.defaultValue; this.style.color = '#999';" onfocus="this.value=''; this.style.color = '#000';" value="Type comment here"></textarea>
...
</form></center></div><div class="clear"></div></div><div class="clear"></div></div><div class="clear"></div>
<?php }
  }
}
?>
