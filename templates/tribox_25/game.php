...
$gameboxwidth = 530; // width of #gameDIV
$gameboxheight = 421; // height of #gameDIV
$maximumwidth = 820; // maximum width you want slider to give to #gameDIV
$body_wrapper_width = 800; // width of body_wrapper
...
<div id="slider" style="width:260px; border: solid #333 2px; color: #333;margin-left:10px;" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left:0%; background: #0969A2;"></a></div>
</div><input type="button" id="resetSlider" value="Reset" height="30" width="90"/><br></center>
<?php
}
?>
<!-- |||||||||=========== Slider End =============== |||||| --> 
...
<div class="facebook_box"><div class="fb-comments" data-href="<?php echo $setting['siteurl'] . 'game/' . $row['id'] . '/' . $row['title'] . '.html';?>" data-colorscheme="light" data-numposts="5" data-width="520"></div></div>
