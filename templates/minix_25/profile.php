...
if(isset($_POST['settings'])) {
	...
	<td class="tg-vn4c"><input type="text" name="name" id="s-a-g" value="' . $row['name'] . '" /></td>
	<td class="tg-vn4c">Email:</td>
	<td class="tg-vn4c"><input type="text" name="email" id="s-a-g" value="' . $row['email'] . '" /></td>
	</tr>
	<tr>
	<td class="tg-0ord">Website:(Remember the http://)</td>
	<td class="tg-0ord"><input type="text" name="website" id="s-a-g" value="' . $row['website'] . '" /></td>
	<td class="tg-Oord">Location:</td>
	<td class="td-Oord"><input type="text" name="location" id="s-a-g" value="' . $row['location'] . '"/></td>
	</tr>
	<tr>
	...
	<td class="tg-vn4c" colspan="3"><textarea name="aboutme" id="d-i-k">'. $row['aboutme'] . '</textarea></td>
	</tr>
	<tr>
	<td class="tg-Oord" colspan="1">Hobbies:</td>
	<td class="tg-Oord" colspan="3"><textarea name="hobbies" id="d-i-k">'. $row['hobbies'] . '</textarea></td>
	</tr>
	<tr>
