	...
	if ( !$b_repeat )
	{
		...
		*/
		...
		$a_browser_types = array(
			...
			array( 'ezooms', false, 'ezooms', 'bot' ),
			array( 'sosospider', false, 'sosopider', 'bot' ),
			array( 'discoverybot', false, 'discoverybot', 'bot' ),
			array( 'voilabot', false, 'voilabot', 'bot' ),
			array( 'archive.org_bot', false, 'archive.org_bot', 'bot' ),
